...
elementos de v1  v2. A função deve retornar a quantidade de números em v. Importante: o vetor
...
int intersecao(float v1[], int tam1, float v2[], int tam2, float v[]){
    int j = 0;
...
int main(void){
    ...
    int qtd_uniao = intersecao(v1, tam1, v2, tam2, v_uniao);
